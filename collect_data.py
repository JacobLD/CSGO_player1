...
def collect_keystrokes():
    # in the order of
    # w,a,s,d,shift,1,2,3,4,5,alt,ctrl,b,f1,e,q,r, *SPACE NEEDS TO BE ADDED
...
def main(mouse_click):
    ...
    while (True):
        ...
        keystrokes = collect_keystrokes()

        training_data.append([screen, keystrokes, mouse_click.click, mouse_click.scroll_up
                             , mouse_click.scroll_down, mouse_data[0][0], mouse_data[0][1], mouse_data[0][2],
                              mouse_data[0][3], mouse_data[0][4], mouse_data[0][5], mouse_data[1][0], mouse_data[1][1],
                              mouse_data[1][2], mouse_data[1][3], mouse_data[1][4], mouse_data[1][5]])
        # print([screen, mouse_data[0], mouse_data[1], keystrokes, mouse_click.click, mouse_click.scroll_up
        #                     , mouse_click.scroll_down])
